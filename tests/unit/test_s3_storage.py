...
def test_create_s3_offline() -> None:
    ...
    _id_mapping = sender(_storage._local_staging_file.parents[1], 1, 10)
    ...
    assert _local_data.config.region_name == "fictionsville"
    assert _local_data.config.bucket == "dummy_bucket"
